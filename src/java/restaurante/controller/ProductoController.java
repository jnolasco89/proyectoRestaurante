...
public class ProductoController implements Serializable {
    ...
    @EJB
    private restaurante.ejb.dao.ProductoFacade ejbFacade;
...
//            return prepareCreate();
            ...
            current = null;
            mostrarMsj("Producto registrado.");
            return "List";
        } catch (Exception e) {
...
//            return "View";
            getFacade().edit(current);
            mostrarMsj("Producto \"" + current.getNombre() + "\" editado.");
            current = null;
            return "List";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
    ...
    public void eliminarElemento(Producto p) {
        try {
            p.setEstado(false);
            getFacade().edit(p);
            mostrarMsj("Producto \"" + p.getNombre() + "\" dada de baja");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
